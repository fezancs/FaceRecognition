...
class IdData:
    ...
    def __init__(
        ...
        #print(aligned_images.shape, id_image_paths.shape)
...
def main(args):
    with tf.Graph().as_default():
        with tf.Session() as sess:
            ...
            #cap = cv2.VideoCapture('sample_fazen_hammad.mp4')#'sample1.mp4')#0)
                ...
                if len(face_patches) > 0:
                    ...
                    for bb, landmark, matching_id, dist in zip(
                        ...
                        if matching_id is None:
                            ...
                            cv2.imwrite("output1/"+matching_id+str(i)+".png",faace*255)
                            #i=i+1
